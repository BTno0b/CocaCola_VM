...
<html lang="en">
  <head>
    ...
    <title>MVC Web 3D Applications</title>
    ...
    <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
      ...
      <div class="collapse navbar-collapse">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link active" id="navHome" href="http://users.sussex.ac.uk/~tt295/3dapp/assignment/index.php/apiCocaCola" >Home</a>
            </li>
            <li class="nav-item">
            ...
            <!-- Dropdown -->
            <li class="nav-item">
              <a id="navModels" class="nav-link"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Fanta, Coke and Costa">Models</a>
            </li>
            <li class="nav-item">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="card img-narrow">
                <a href="../application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Fanta Can Render">
            ...
            <div class="col-sm-4">
              <div class="card img-narrow">
                <a href="../application/assets/images/renderImages/costa.jpg" data-fancybox data-caption="My 3D Costa Cup Render" >
              ...
              <div class="card">
                <div class="card-body">
                  <div class="card-Title">
                    <div id="AboutTitle" class="card-title"></div>
                  </div>
        ...
        <div id="interaction" class="row" style="display:none;">
          ...
          <div class="col-sm-4">
            <div class="card text-left">
              ...
              <div class="card-body" id="Fanta_cam" style="display:none;">
                <div id="CameraTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>
                
                <!--Camera Buttons-->
                <a href="#" class="btn btn-success btn-responsive" onclick="cameraFront_Fanta();">Default</a>
                <a href="#" class="btn btn-primary btn-responsive" onclick="cameraBack_Fanta();">Back</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraLeft_Fanta();">Left</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraRight_Fanta();">Right</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraTop_Fanta();">Top</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraBottom_Fanta();">Bottom</a>
                        
              </div>

              <div class="card-body" id="Coca_cam" style="display:none;">
                <div id="CameraTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>
                
                <!--Camera Buttons-->
                <a href="#" class="btn btn-success btn-responsive" onclick="cameraFront_Coca();">Default</a>
                <a href="#" class="btn btn-primary btn-responsive" onclick="cameraBack_Coca();">Back</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraLeft_Coca();">Left</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraRight_Coca();">Right</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraTop_Coca();">Top</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraBottom_Coca();">Bottom</a>
                
              </div>

              <div class="card-body" id="Costa_cam" style="display:none;">
                <div id="CameraTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>
                
                <!--Camera Buttons-->
                <a href="#" class="btn btn-success btn-responsive" onclick="cameraFront_Costa();">Default</a>
                <a href="#" class="btn btn-primary btn-responsive" onclick="cameraBack_Costa();">Back</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraLeft_Costa();">Left</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraRight_Costa();">Right</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraTop_Costa();">Top</a>
                <a href="#" class="btn btn-secondary btn-responsive" onclick="cameraBottom_Costa();">Bottom</a>
                
              </div>
         
              <div id="CameraSubtitle" class="card-text x3dCameraDescription drinksText card-body"></div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="card text-left">
              ...
              <div class="card-body">
                <div id="AnimationTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>
                
                <!--Animateion Buttons-->
                <a href="#" class="btn btn-outline-light btn-responsive" onclick="spin();">Rotate Model</a>
                <a href="#" class="btn btn-outline-dark btn-responsive" onclick="stopRotation();">Stop</a>
                          
                <div id="AnimationSubtitle" class="card-text x3dCameraDescription drinksText"></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="card text-left">
              <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                  <li class="nav-item">
                    <a href="#" class="nav-link active">Render</a>
                  </li>
                  <!-- Dropdown nav-tab -->
              ...
              <div class="card-body">
                <div id="RenderTitle" class="card-Title x3dCamera_Subtitle drinksText"></div>
                ...
                <div id="RenderSubtitle" class="card-text x3dCameraDescription drinksText"></div>
              </div>
            </div>
          </div>
